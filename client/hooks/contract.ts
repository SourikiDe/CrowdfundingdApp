...
export const CONTRACT_ADDRESS =
  "CBZKGQ45DB5RXH4S2ANMHIIQP4PGQTTNEPJT447HAXOOCH6S75NW5K33";
 ...
 * Calls: contribute(contributor: Address, creator: Address, amount: i128)
 */
...
/**
 * Get campaign goal (read-only).
 * Calls: get_campaign(creator: Address) -> i128
 * Returns: The campaign goal amount
 */
...
/**
 * Get contribution amount (read-only).
 * Calls: get_contribution(contributor: Address) -> i128
